...
const AppHeaderDropdown = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const response = await axiosInstance.get('/stock-requests/notifications')
      if (response.data.success) {
  ...
  return (
    <>
      <CDropdown variant="nav-item" alignment="end">
        ...
        <CDropdownMenu className="pt-1 w-[400px]">
          <CDropdownHeader
            className="bg-[#2759A2] text-white fw-semibold text-center py-1"
            style={{ backgroundColor: '#2759A2', height: '5px', padding: '10px' }}
          ></CDropdownHeader>
          ...
          >
            ...
            {loadingNotifications ? (
              <div className="text-center py-4">
                ...
                <div className="mt-2 text-muted" style={{ fontSize: '12px' }}>Loading notifications...</div>
              </div>
            ) : notifications.length > 0 ? (
              <div>
                {notifications.map((notification, index) => (
                  ...
                  >
                    ...
                    <div className="d-flex justify-content-between align-items-center mt-2">
                      ...
                      >
                        {notification.center?.centerName || 'Unknown Center'}
                      </small>
                      <small 
                        style={{ 
                          fontSize: '10px', 
