...
{
const initialData = [
           { date: '25 july 2025', type:'Building', center: 'Nashik', product: 'Ball' ,productType:'New',qty:'12',userOrBuilding:'T56 junction',address:'T56 junction',mobile:''},
           { date: '25 july 2025', type: 'Building', center: 'Nashik', product: 'Cable',productType:'New',qty:'2',userOrBuilding:'T56 junction',address:'T56 junction',mobile:''},
         ];
    ...
    return(
        <>
         {/* <h1 className='headingF'>Usage Stock Report</h1>  */}
