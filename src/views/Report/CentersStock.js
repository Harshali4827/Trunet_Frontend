...
function CenterStock()
{
const initialData = [
           { center: 'GOPL', product:'40Amp Change-Over Switch', category: 'HO ASSETS', stock: '1' ,damage:'0'},
           { center: 'Vashi', product: 'switch', category: 'Asset', stock: '4',damage:'0'},
         ];
                ...
                <thead>
                  <tr>
                    ...
                    <th style={thStyle}>Category{renderSortControls('category')}</th>
                     <th style={thStyle}>Stock {renderSortControls('stock')}</th>
                      <th style={thStyle}>Damage{renderSortControls('damage')}</th>
                  </tr>
                </thead>
                <tbody>
                  {data.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td style={tdStyle}>{item.damage}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
