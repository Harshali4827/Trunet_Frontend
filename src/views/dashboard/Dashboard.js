...
// import CenterUsage from 'src/components/CenterUsage';
// import IndentCard from 'src/components/IndentCard';
// import LoginHistory from 'src/components/LoginHistory';
...
//   return (
//     <div className="relative bg-[#ECF0F5] min-h-screen">
//       {showNotice && (
//         <div className="fixed inset-0 z-50 flex pt-8 justify-center">
//           <div className="absolute inset-0 bg-black opacity-60" />
//           <div
//             className={`relative bg-[#3DC1DA] text-white w-[600px] h-[460px] shadow-xl z-10 transform transition-all duration-500 ${
//               animate ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'
//             }`}
//           >
//             <div className="bg-[#2759A2] px-4 py-3.5 border-b border-[#776C56]">
//               <h2 className="text-[18px] text-white">Notice</h2>
//             </div>
//             <div className="px-4 pt-9">
//               <p className="text-2xl leading-[1.5rem] mb-6">
...
//               </p>
//               <p className="text-[#3c8dbc] leading-[1.5rem] mb-10 text-2xl cursor-pointer hover:opacity-20">
...
//               <a
//                 href="#"
//                 className="text-[#3c8dbc] text-2xl cursor-pointer hover:opacity-20"
//                 onClick={(e) => {
//                   e.preventDefault();
...
//             <button
//               onClick={closeNotice}
//               className="absolute top-2 right-4 text-gray-600 text-xl hover:text-gray-800 cursor-pointer"
//             >
//               &times;
//             </button>
//           </div>
