...
// useEffect(() => {
//     if (visible && product?.product?._id) {
//       // Initialize selectedSerials with previously approved serials if available
//       const prevSerials = {};
//       if (product.approvedSerials?.length > 0) {
//         product.approvedSerials.forEach((sn, index) => {
//           prevSerials[index + 1] = sn; // SR numbers start from 1
//         });
//       }
...
//       const response = await axiosInstance.get(`/stockpurchase/serial-numbers/product/${productId}`);
