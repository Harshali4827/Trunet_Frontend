...
const SearchStockModel = ({ visible, onClose, onSearch, centers }) => {
  ...
  const handleSearch = () => {
    ...
    if (searchData.dateFilter) {
      apiSearchData.dateFilter = searchData.dateFilter;
      if (searchData.dateFilter === 'Custom' && searchData.startDate && searchData.endDate) {
      ...
      <CModal size="lg" visible={visible} onClose={onClose}>
        ...
        <CModalBody>
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              <label className="form-label">Status Change Date</label>
              <DatePicker
                value={searchData.dateFilter === 'Custom' && searchData.startDate && searchData.endDate 
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <DatePicker
                ...
                placeholder="Select Indent Date Range"
                className="no-radius-input date-input"
              />
            </div>
            <div className="form-group">
